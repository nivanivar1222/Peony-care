                ...
                while ($row = $qry->fetch_assoc()):
                    ...
                    <div class="d-flex w-100 justify-content-between  mb-2 py-2 border-bottom cart-item">
                        <div class="d-flex align-items-center col-8">
                            <span class="mr-2"><a href="javascript:void(0)" class="btn btn-sm btn-outline-danger rem_item"
                                    data-id="<?php echo $row['id'] ?>"><i class="fa fa-trash"></i></a></span>
                            <img src="<?php echo validate_image($img) ?>" loading="lazy" class="cart-prod-img mr-2 mr-sm-2"
                                alt="">
                            <div>
                                <p class="mb-1 mb-sm-1">
                                    <?php echo $row['name'] ?>
                                </p>
                                ...
                                <div>
                                    <div class="input-group" style="width:130px !important">
                                        ...
                                        <input type="number" class="form-control form-control-sm qty text-center cart-qty"
                                            ...
                                            value="<?php echo $row['quantity'] ?>" aria-describedby="button-addon1"
                                            data-id="<?php echo $row['id'] ?>" readonly>
                        ...
                        <div class="col text-right align-items-center d-flex justify-content-end">
                            <h4><b class="total-amount">
                                    <?php echo format_num($row['price'] * $row['quantity']) ?>
                                </b></h4>
                        </div>
                    </div>
                <?php endwhile; ?>
