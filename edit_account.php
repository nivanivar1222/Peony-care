                    ...
                    <form action="" id="update_account">
                        ...
                        <div class="form-group">
                            ...
                            <select name="gender" id="" class="custom-select select" required>
                                <option <?php echo $_settings->userdata('gender') == "Male" ? "selected" : '' ?>>Male
                                </option>
                                <option <?php echo $_settings->userdata('gender') == "Female" ? "selected" : '' ?>>Female
                                </option>
                            </select>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <small class="text-muted"><i>Leave this blank if you don't want to update your
                                    password.</i></small>
                        </div>
                        <div class="form-group">
